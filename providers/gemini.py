...
class GeminiModelProvider(RegistryBackedProviderMixin, ModelProvider):
    ...
    def generate_content(
        ...
        **kwargs,
        ...
        # Gemini 3 / 3.1 Pro Preview currently reject medium thinking budgets; bump to high.
        effective_thinking_mode = thinking_mode
        if resolved_model_name in ("gemini-3-pro-preview", "gemini-3.1-pro-preview") and thinking_mode == "medium":
            logger.debug(
